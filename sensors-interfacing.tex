...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{ofdm.png} 
    \includegraphics[width=0.5\textwidth]{ofdm2.png} 
    \caption{OFDM}
\end{figure}
...
\begin{itemize}
    ...
    \item Door de in fase gesynchroniseerde subcarriers
    \item hebben de overlappende frequenties geen nadelig effect
\end{itemize}
...
\section{Herhaling: Te kennen formules}
\subsection{Frequentie en periode}
$F = \frac1T$ $\Leftrightarrow$ $T = \frac1F$

\subsection{Analoog naar digitaal omzetten}
...
\subsection{Golflengte}
$\lambda = \frac{c}{f}$, met $c =$ de lichtsnelheid $= 299\ 792\ 458\ \text{m/s} \approx 300\ 000\ 000\ \text{m/s}$
